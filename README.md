...
![](https://github.com/vishalmishraa/MultithreadedProxyWebServer/blob/main/pics/UML.JPG)
...
```bash
$ git clone https://github.com/vishalmishraa/MultithreadedProxyWebServer.git
